...
import { createMatch, createTeam, getAllPlayers, getAllTeams, getAllTeamDetails, updateMatch } from "../controllers/organizer.controller.js";
...
router.put("/organizer/match", [verifyToken, verifyOrganizer], updateMatch);
